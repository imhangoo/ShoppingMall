             ...
             <div id="head_right">
                 <div id="head_landing">
                 	<% 
                 		...
                 		if(u!=null){ 
                 	%>
                 		<a class="head_nav_a" href="userservice.jsp"><%=u.getUsername()%></a>
                 		<span>|</span>
                     	<a class="head_nav_a" href="index.jsp?logout=true">Log out</a>
                 	<%
                 		}else{
                 	%>
                 	
                     <a class="head_nav_a" href="login.jsp">Login</a>
                     <span>|</span>
                     <a class="head_nav_a">Register</a>
                     <%}%>
                 </div>
                 <div id="head_car">
                     <a class="head_car_text">Cart(0)</a>
